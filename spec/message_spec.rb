...
RSpec.describe VatInfo::Message do
  ...
  describe '#uuid_zpravy' do
    it 'returns default if no uuid was set' do
      ...
      msg = VatInfo::Message.new()

      expect(msg.uuid_zpravy).to eq '--automatic_uuid--'
    end

    it 'returns given value' do
      msg = VatInfo::Message.new(uuid_zpravy: '--uuid--')
  ...
  describe '#dat_odesl' do
    ...
    it 'returns given value' do
      msg = VatInfo::Message.new(dat_odesl: '1.1.2017')
  ...
  describe '#prvni_zaslani' do
    ...
    it 'returns given value' do
      msg = VatInfo::Message.new(prvni_zaslani: false)
  ...
  describe '#rezim' do
    ...
    it 'returns given value' do
      msg = VatInfo::Message.new(rezim: 1)
  ...
  describe '#dat_trzby' do
    ...
    it 'returns given value' do
      msg = VatInfo::Message.new(dat_trzby: '1.1.2017')
  ...
  describe '#head_attributes' do
    it 'returns hash with attributes for Hlavicka element' do
      msg = VatInfo::Message.new(uuid_zpravy: '--uuid--',
                             dat_odesl: Time.parse('1.1.2017 00:00 UTC').strftime(VatInfo::Message::DATE_FORMAT),
  ...
  describe '#data_attributes' do
    it 'returns hash with attributes for Data element' do
      msg = VatInfo::Message.new(dic_popl: 'CZ00000019',
                             dic_poverujiciho: 'CZ1212121218',
                             id_provoz: '1',
                             id_pokl: '11',
                             porad_cis: '1',
                             dat_trzby: Time.parse('1.1.2017 00:00 UTC').strftime(VatInfo::Message::DATE_FORMAT),
                             celk_trzba: '1',
                             zakl_nepodl_dph: '2',
                             zakl_dan1: '3',
                             dan1: '4',
